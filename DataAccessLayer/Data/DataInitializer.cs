...
namespace DataAccessLayer.Data
{
    public static class DataInitializer
    {
        ...
        private static List<PurchaseHistory> PreparePurchaseHistory()
        {
            ...
            { 
                new PurchaseHistory { Id = 1, BookId = 1, CustomerId = 1, PurchaseDate = DateTime.SpecifyKind(new DateTime(2023, 10, 10), DateTimeKind.Utc), TotalPrice = 15.99M, Paid = false },
                new PurchaseHistory { Id = 2, BookId = 3, CustomerId = 1, PurchaseDate = DateTime.SpecifyKind(new DateTime(2023, 10, 10), DateTimeKind.Utc), TotalPrice = 25.99M, Paid = true },
                new PurchaseHistory { Id = 3, BookId = 4, CustomerId = 2, PurchaseDate = DateTime.SpecifyKind(new DateTime(2023, 10, 10), DateTimeKind.Utc), TotalPrice = 18.99M, Paid = true },
                new PurchaseHistory { Id = 4, BookId = 5, CustomerId = 3, PurchaseDate = DateTime.SpecifyKind(new DateTime(2023, 10, 10), DateTimeKind.Utc), TotalPrice = 22.99M, Paid = true }

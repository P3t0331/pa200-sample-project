    ...
    public static class DataInitializer
    {
        ...
        private static List<PurchaseHistory> PreparePurchaseHistory()
        {
            ...
            { 
                ...
                new PurchaseHistory { Id = 2, BookId = 3, CustomerId = 1, PurchaseDate = new DateTimeOffset(2023, 8, 15, 0, 0, 0, TimeSpan.Zero), TotalPrice = 25.99M, Paid = true },
                new PurchaseHistory { Id = 3, BookId = 4, CustomerId = 2, PurchaseDate = new DateTimeOffset(2023, 9, 5, 0, 0, 0, TimeSpan.Zero), TotalPrice = 18.99M, Paid = true },
                new PurchaseHistory { Id = 4, BookId = 5, CustomerId = 3, PurchaseDate = new DateTimeOffset(2023, 7, 20, 0, 0, 0, TimeSpan.Zero), TotalPrice = 22.99M, Paid = true }
